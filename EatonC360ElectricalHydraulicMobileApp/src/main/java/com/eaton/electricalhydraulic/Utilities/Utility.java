package com.eaton.electricalhydraulic.Utilities;
...
public class Utility {
	...
	public String app_path,deviceName, platformName, platformVersion, automationName, bundleId, udid, updatedWDABundleId, localURL,excel_path;
	...
	public Utility() throws Exception {
		...
		this.excel_path = config.getProperty("excelPath");
		...
		this.automationName = config.getProperty("automationName");
		this.bundleId = config.getProperty("bundleId");
		this.udid = config.getProperty("udid");
		this.localURL = config.getProperty("localURL");
		this.updatedWDABundleId = config.getProperty("updatedWDABundleId");
